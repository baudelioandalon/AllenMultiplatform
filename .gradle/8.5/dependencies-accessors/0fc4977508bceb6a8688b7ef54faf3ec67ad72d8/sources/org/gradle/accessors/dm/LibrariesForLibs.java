...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with versionRef 'composeImageLoader'.
        ...
        /**
         * Creates a dependency provider for kstore (io.github.xxfast:kstore)
     * with versionRef 'kstore'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKstore() {
            return create("kstore");
    }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'compose.uitooling'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'ktor.negotiation'.
             * This dependency was declared in catalog libs.versions.toml
             */
         ...
         * with versionRef 'ktor.serialization'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class MokoLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'moko.core'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() {
                return create("moko.core");
        }

            /**
             * Creates a dependency provider for mvvm (dev.icerock.moko:mvvm-compose)
         * with versionRef 'moko.mvvm'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class SqlDelightDriverLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'sqlDelight'.
            ...
            /**
             * Creates a dependency provider for js (app.cash.sqldelight:web-worker-driver)
         * with versionRef 'sqlDelight'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getJs() {
                return create("sqlDelight.driver.js");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: apollo (4.0.0-beta.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: buildConfig (4.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: composeImageLoader (1.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: kstore (0.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKstore() { return getVersion("kstore"); }
            ...
            /**
             * Returns the version associated to this alias: napier (2.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KamelVersionAccessors extends VersionFactory  {
        ...
        public KamelVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kamel.image (0.9.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KtorVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("ktor"); }
            ...
            /**
             * Returns the version associated to this alias: ktor.negotiation (2.3.7)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getNegotiation() { return getVersion("ktor.negotiation"); }

            /**
             * Returns the version associated to this alias: ktor.serialization (2.3.7)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSerialization() { return getVersion("ktor.serialization"); }
    ...
    public static class MokoVersionAccessors extends VersionFactory  {
        ...
        public MokoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: moko.core (0.16.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCore() { return getVersion("moko.core"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for apollo to the plugin id 'com.apollographql.apollo3'
             * with versionRef 'apollo'.
